...
void draw_data_10_125_dls()
{
 ...
 TFile *f6 = new TFile("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/cut_scan/manualy_weight/ROOT/scan_cut_fit/10_125_bins/pT_10_125_dlscan_5_6.root");
...
const Int_t NBINS = 5;
double edges[NBINS+1]={1.5,3.5,4,5.5,7.5,9};
...
TFile * result = new TFile("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/cut_scan/manualy_weight/ROOT/scan_cut_fit/data_fit/pp_10_125_separatefit_dlsbins_update_data.root","RECREATE");
h_data->Write();
fit_fun->Write();
result->Close();
