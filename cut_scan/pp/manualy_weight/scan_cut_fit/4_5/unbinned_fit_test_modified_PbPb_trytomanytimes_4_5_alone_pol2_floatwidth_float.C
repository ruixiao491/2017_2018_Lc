...
void unbinned_fit_test_modified_PbPb_trytomanytimes_4_5_alone_pol2_floatwidth_float(TString nt_number, TString outfile, TString outfigure, int range1, int range2){
//pp 10-20
...
double mean_value = 2.28701e+00;
TH1F *h_output = new TH1F ("h_output","output",2,0,2);

TNtuple *nt5 = (TNtuple*)f->Get(nt_number);
...
RooRealVar p2("p2","p2",-1.0445e-01,-1,1);

RooRealVar float_width("float_width","float_width",7.78834e-02,7.78834e-02,7.78834e-02);
