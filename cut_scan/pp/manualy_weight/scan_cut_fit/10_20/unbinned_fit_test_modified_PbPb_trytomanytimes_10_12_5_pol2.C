...
//pp 10-20
TFile * f = new TFile("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/manually_cut_scan_weight_10_20_trackpT_gr_whole.root");
//pp 10-20 pol2
...
RooPlot *massframe = new RooPlot("mass","mass",mass,2.2,2.36,20);
...
RooFitResult * r = model.fitTo(ds,Extended(kTRUE),Range(2.2,2.36),Save());
...
model.plotOn(massframe,Name("model"),Range(2.2,2.36),LineColor(2));
