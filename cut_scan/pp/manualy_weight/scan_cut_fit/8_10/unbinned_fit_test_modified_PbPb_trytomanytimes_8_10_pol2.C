...
void unbinned_fit_test_modified_PbPb_trytomanytimes_8_10_pol2(TString nt_number, TString outfile, TString outfigure, int range1, int range2){
...
double mean_value = 2.28695e+00;
TH1F *h_output = new TH1F ("h_output","output",2,0,2);

TNtuple *nt2 = (TNtuple*)f->Get(nt_number);
...
*/
RooRealVar float_width("float_width","float_width",-6.50785e-02,-6.50785e-02,-6.50785e-02);
...
massframe->SetAxisRange(range1,range2,"Y");//uniform train 
