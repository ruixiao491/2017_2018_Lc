...
void unbinned_fit_test_modified_PbPb_trytomanytimes__special_5_6_willdelet_pol2_releaselimit_0_0(TString nt_number, TString outfile, TString outfigure, int range1, int range2){
//pp 10-20
...
double mean_value = 2.28792e+00;
TH1F *h_output = new TH1F ("h_output","output",2,0,2);



TNtuple *nt4 = (TNtuple*)f->Get(nt_number);
...
RooRealVar float_width("float_width","float_width",2.24934e-01,2.24934e-01,2.24934e-01);
