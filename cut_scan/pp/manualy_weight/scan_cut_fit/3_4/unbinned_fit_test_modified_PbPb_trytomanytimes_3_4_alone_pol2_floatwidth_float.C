...
void unbinned_fit_test_modified_PbPb_trytomanytimes_3_4_alone_pol2_floatwidth_float(TString nt_number, TString outfile, TString outfigure, int range1, int range2){
//pp 10-20
TFile * f = new TFile("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/fill_3_100_BDTG/cut_scan_working_points_scan_whole.root");
...
RooRealVar float_width("float_width","float_width",6.23196e-01,6.23196e-01,6.23196e-01);
