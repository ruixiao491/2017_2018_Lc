...
void unbinned_fit_test_modified_PbPb_trytomanytimes_6_8_pol2(TString nt_number, TString outfile, TString outfigure, int range1, int range2){
//pp 10-20
...
RooRealVar float_width("float_width","float_width",1.66638e-01,1.66638e-01,1.66638e-01);
...
massframe->SetAxisRange(range1,range2,"Y");//uniform cuts
massframe->Draw();
