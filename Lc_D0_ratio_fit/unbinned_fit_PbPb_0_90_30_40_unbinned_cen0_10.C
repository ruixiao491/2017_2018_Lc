...
TFile *f_D0 = new TFile("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/Lc_D0_ratio/D0_crosssection_cen0_90_0_10_PbPb.root");
...
TH1D *hDpt_0_10 = (TH1D*) f_D0->Get("hDpt_0_10");
...
double ND0 = hDpt_0_10->GetBinContent(hDpt_0_10->FindBin(35));
double ND0_err = hDpt_0_10->GetBinError(hDpt_0_10->FindBin(35));
double accp = hrecoeff_combine->GetBinContent(hrecoeff_combine->FindBin(35));

double promptratio = 0.9;


cout<<"begin fitting"<<endl;
RooRealVar Accp("Accp","Accp",accp,accp,accp);
RooRealVar P_ratio("P_ratio","P_ratio",promptratio,promptratio,promptratio);
RooRealVar ND0_var("ND0_var","ND0_var",ND0,ND0-10*ND0_err,ND0+10*ND0_err);
RooRealVar LcD0ratio("LcD0ratio","LcD0ratio",0.10328,-10,10);
RooFormulaVar NumSig("NumSig","@0*@1*10*2*0.0635*3.6505427e+08*23.2143*@2/(@3*0.97*1000)",RooArgSet(LcD0ratio,ND0_var,Accp,P_ratio));
...
RooFitResult * r = modelc.fitTo(ds,Extended(kTRUE),Range(2.108,2.444),Minos(kTRUE),Save());
...
modelc.plotOn(massframe,Name("back"),Components(back),LineColor(9),LineStyle(7));
...
float a = LcD0ratio.getVal();
float b = LcD0ratio.getAsymErrorLo();
float c = LcD0ratio.getAsymErrorHi();
...
c1->SaveAs("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/Lc_D0_ratio/ratio_plots/with_accp_PVz_reweight/PbPb_30_40_rec_unbinned_3gaus_cen0_10_ratio.pdf");
c1->SaveAs("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/Lc_D0_ratio/ratio_plots/with_accp_PVz_reweight/PbPb_30_40_rec_unbinned_3gaus_cen0_10_ratio.C");

TFile *result = new TFile("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/Lc_D0_ratio/ratio_plots/with_accp_PVz_reweight/PbPb_30_40_2gaus_pol3_unbinned_rec_3gaus_cen0_10_ratio.root","RECREATE");
