...
void unbinned_fit_PbPb_0_90_15_20_unbinned(){
/////PbPb cen0_100%

TFile *f =  new TFile("/scratch/halstead/x/xiao147/2018_PbPb_transfer_from_brown_rice/final_PbPb_masstuples_copyfrombrown_forRaa_simultaneousfit/masstuples_10_30_differentvarialbles_rec_uniformcuts_final.root");
TFile *f_accp =  new TFile("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/accp/ROOT/several_turns/third_turn_PVz/combine_accp/accp_P_cen0_90_thirdturn_PVz.root");
TFile *f_fun = new TFile("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/MC_fit/3gaus_fit/10_40_rec/10_30_uniform_rec/pp_15_20_MC_3gaus_fit_finbins.root");
...
TFile *f_fun_pp = new TFile("/scratch/halstead/x/xiao147/2017_pp_firstturn_dataproduction_0416_2019/signal_extraction/pp_3_100_BDTG/2gaus_1fit/pp_15_20_BDT4_100_MC_2gaus_fit_hits.root");
...
double accp_PbPb = hrecoeff_combine->GetBinContent(hrecoeff_combine->FindBin(17));
double promptratio_PbPb = 0.86;
double accp_pp = hrecoeffi_weighted_pp->GetBinContent(hrecoeffi_weighted_pp->FindBin(17));
double prompratio_pp = h_ratio_pp->GetBinContent(h_ratio_pp->FindBin(17));
TNtuple *nt_PbPb = (TNtuple*)f->Get("nt_3");
TNtuple *nt_pp = (TNtuple*)f_pp->Get("BDTG_15_20_value_0_77");
...
RooRealVar p1_pp("p1_pp","p1_pp",-1.52363e-01,-1,1);
RooRealVar p2_pp("p2_pp","p2_pp",-6.10753e-02,-1,1);
RooRealVar p3_pp("p3_pp","p3_pp",0,-1,1);

RooRealVar float_width_pp("float_width_pp","float_width_pp",0.1,-1,1);
...
RooRealVar NumSig_pp("NumSig_pp","Number of Signal pp",numbers_pp,-numbers_pp*8,numbers_pp*8);
RooRealVar NumBkg_pp("NumBkg_pp","Number of Background pp",numberb_pp,-numberb_pp*8, numberb_pp*8);
...
RooRealVar p1_PbPb("p1_PbPb","p1_PbPb",-2.29166e-01,-1,1);
RooRealVar p2_PbPb("p2_PbPb","p2_PbPb",-5.46823e-02,-1,1);
RooRealVar p3_PbPb("p3_PbPb","p3_PbPb",0,-1,1);

RooRealVar float_width_PbPb("float_width_PbPb","float_width_PbPb",0.1,-0.5,0.5);
...
RooFormulaVar NumSig_PbPb("NumSig_PbPb","@0*@1*@2*3.2935122e+09*6.23397*@3/(@4*0.252*1e6*0.97*@5*1000)",RooArgSet(Raa,NumSig_pp,P_ratio_pp,Accp_PbPb,P_ratio_PbPb,Accp_pp));
RooRealVar NumBkg_PbPb("NumBkg_PbPb","Number of Background PbPb",numberb_PbPb,-numberb_PbPb*8,numberb_PbPb*8);
...
//save the Raa value
int a = round(Raa.getVal());
int b = abs(round(Raa.getAsymErrorLo()));
int c = round(Raa.getAsymErrorHi());
...
massframe1->SetAxisRange(1200,1950,"Y");///separate pt train
massframe1->Draw();
TLatex* tex_pp;
tex_pp = new TLatex(0.16,0.85,"15 < p_{T} < 20 GeV/c");
tex_pp->SetNDC();
...
massframe2->SetAxisRange(27000,50000,"Y");
massframe2->Draw();

TLatex* tex;
tex = new TLatex(0.2,0.84,"15 < p_{T} < 20 GeV/c");
tex->SetNDC();
tex->SetTextFont(42);
...
tex = new TLatex(0.2,0.72,"Cent. 0-90%");
tex->SetNDC();
tex->SetTextFont(42);
tex->SetTextSize(0.047);
tex->SetLineWidth(2);
...
c1->SaveAs("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/Raa_ratio_fit/full_statistics_pp_BDTG_3_100_workingscan_077/PbPb_15_20_rec_unbinned_3gaus_Raa.pdf");
c1->SaveAs("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/Raa_ratio_fit/full_statistics_pp_BDTG_3_100_workingscan_077/PbPb_15_20_rec_unbinned_3gaus_Raa.C");

TFile *result = new TFile("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/Raa_ratio_fit/full_statistics_pp_BDTG_3_100_workingscan_077/PbPb_15_20_2gaus_pol3_unbinned_rec_3gaus_Raa.root","RECREATE");
