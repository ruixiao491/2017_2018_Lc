...
void unbinned_fit_PbPb_0_90_20_30_unbinned(){
/////PbPb cen0_100%
...
TFile *f_fun_pp = new TFile("/scratch/halstead/x/xiao147/2017_pp_firstturn_dataproduction_0416_2019/signal_extraction/pp_3_100_BDTG/2gaus_1fit/pp_20_30_BDT4_100_MC_2gaus_fit_hits.root");
...
double accp_PbPb = hrecoeff_combine->GetBinContent(hrecoeff_combine->FindBin(25));
double promptratio_PbPb = 0.9;
double accp_pp = hrecoeffi_weighted_pp->GetBinContent(hrecoeffi_weighted_pp->FindBin(25));
double prompratio_pp = h_ratio_pp->GetBinContent(h_ratio_pp->FindBin(25));
TNtuple *nt_PbPb = (TNtuple*)f->Get("nt_4");
TNtuple *nt_pp = (TNtuple*)f_pp->Get("BDTG_20_30_value_0_77");
...
RooRealVar p1_pp("p1_pp","p1_pp",-1.38759e-01,-1,1);
RooRealVar p2_pp("p2_pp","p2_pp",-9.08457e-02,-1,1);
RooRealVar p3_pp("p3_pp","p3_pp",0,-1,1);

RooRealVar float_width_pp("float_width_pp","float_width_pp",1.48369e-01,-1,1);
...
RooRealVar p1_PbPb("p1_PbPb","p1_PbPb",-2.67720e-01,-1,1);
...
massframe1->SetAxisRange(400,820,"Y");///separate pt train
massframe1->Draw();
TLatex* tex_pp;
tex_pp = new TLatex(0.16,0.85,"20 < p_{T} < 30 GeV/c");
tex_pp->SetNDC();
...
massframe2->SetAxisRange(9000,22000,"Y");
massframe2->Draw();
TLatex* tex;
tex = new TLatex(0.2,0.84,"20 < p_{T} < 30 GeV/c");
tex->SetNDC();
tex->SetTextFont(42);
...
c1->SaveAs("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/Raa_ratio_fit/full_statistics_pp_BDTG_3_100_workingscan_077/PbPb_20_30_rec_unbinned_3gaus_Raa.pdf");
c1->SaveAs("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/Raa_ratio_fit/full_statistics_pp_BDTG_3_100_workingscan_077/PbPb_20_30_rec_unbinned_3gaus_Raa.C");

TFile *result = new TFile("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/Raa_ratio_fit/full_statistics_pp_BDTG_3_100_workingscan_077/PbPb_20_30_2gaus_pol3_unbinned_rec_3gaus_Raa.root","RECREATE");
