...
void unbinned_fit_PbPb_0_90_10_125_unbinned(){
/////PbPb cen0_100%
...
double accp_PbPb = hrecoeff_combine->GetBinContent(hrecoeff_combine->FindBin(11));
double promptratio_PbPb = 0.8;
double accp_pp = hrecoeffi_weighted_pp->GetBinContent(hrecoeffi_weighted_pp->FindBin(11));
double prompratio_pp = h_ratio_pp->GetBinContent(h_ratio_pp->FindBin(11));
...
RooRealVar p1_pp("p1_pp","p1_pp",-1.55377e-01,-1,1);
RooRealVar p2_pp("p2_pp","p2_pp",-4.53554e-02,-1,1);
...
RooRealVar p1_PbPb("p1_PbPb","p1_PbPb",2.97279e-02,-1,1);
...
massframe2->SetAxisRange(560000,670000,"Y");
massframe2->Draw();
...
c1->SaveAs("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/Raa_ratio_fit/full_statistics_pp_BDTG_3_100_workingscan_077/PbPb_10_125_rec_unbinned_Raa.pdf");
c1->SaveAs("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/Raa_ratio_fit/full_statistics_pp_BDTG_3_100_workingscan_077/PbPb_10_125_rec_unbinned_Raa.C");

TFile *result = new TFile("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/Raa_ratio_fit/full_statistics_pp_BDTG_3_100_workingscan_077/PbPb_10_125_2gaus_pol3_unbinned_Raa.root","RECREATE");
