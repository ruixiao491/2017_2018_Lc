...
void unbinned_fit_PbPb_0_90_8_10_unbinned(){
/////PbPb cen0_100%

TFile *f =  new TFile("/scratch/halstead/x/xiao147/2018_PbPb_transfer_from_brown_rice/final_PbPb_masstuples_copyfrombrown_forRaa_simultaneousfit/pt_8_10_ceno_90_alpha008_2servers_whole.root");

TFile *f_fun = new TFile("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/MC_fit/3gaus_fit/10_40_rec/10_30_uniform_rec/pp_8_10_MC_3gaus_fit_finbins.root");
...
TFile *f_fun_pp = new TFile("/home/xiao147/private/newchannel_lambda_CtoproduceDntuple/CMSSW_7_5_8_patch3/src/Bfinder/Bfinder/Dntuple/TMVA_official_MC/signal_exaction/ROOT_signalextraction_witheventselection/signalectraction/forAN_plot/change_fit_function/pp/pol3/8_10_pp_officialTMVAcuts_2gaus_pol3_weighted_ptcuts_eventselection_changefit_L_changefit_function.root");
...
double accp_PbPb = hrecoeff_combine->GetBinContent(hrecoeff_combine->FindBin(9));
double promptratio_PbPb = 0.9;
double accp_pp = hrecoeffi_weighted_pp->GetBinContent(hrecoeffi_weighted_pp->FindBin(9));
double prompratio_pp = h_ratio_pp->GetBinContent(h_ratio_pp->FindBin(9));
TNtuple *nt_PbPb = (TNtuple*)f->Get("nt_mass");
TNtuple *nt_pp = (TNtuple*)f_pp->Get("BDTG_8_10_value_0_77");
...
RooRealVar NumBkg_pp("NumBkg_pp","Number of Background pp",numberb_pp,-numberb_pp*12, numberb_pp*12);
...
massframe1->SetAxisRange(10000,15500,"Y");///separate pt train
massframe1->Draw();
TLatex* tex_pp;
tex_pp = new TLatex(0.16,0.85,"8 < p_{T} < 10 GeV/c");
tex_pp->SetNDC();
...
TLatex* tex;
tex = new TLatex(0.2,0.84,"8 < p_{T} < 10 GeV/c");
tex->SetNDC();
tex->SetTextFont(42);
...
c1->SaveAs("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/Raa_ratio_fit/full_statistics_pp_BDTG_3_100_workingscan_077/PbPb_8_10_alpha008_Raa.pdf");
c1->SaveAs("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/Raa_ratio_fit/full_statistics_pp_BDTG_3_100_workingscan_077/PbPb_8_10_alpha008_Raa.C");

TFile *result = new TFile("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/Raa_ratio_fit/full_statistics_pp_BDTG_3_100_workingscan_077/PbPb_8_10_2gaus_pol3_alpha008_Raa.root","RECREATE");
