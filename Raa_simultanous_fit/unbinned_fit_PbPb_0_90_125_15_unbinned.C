...
void unbinned_fit_PbPb_0_90_125_15_unbinned(){
/////PbPb cen0_100%
...
TFile *f_fun = new TFile("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/MC_fit/3gaus_fit/10_40_rec/10_30_uniform_rec/pp_12_15_MC_3gaus_fit_finbins.root");
...
TFile *f_fun_pp = new TFile("/scratch/halstead/x/xiao147/2017_pp_firstturn_dataproduction_0416_2019/signal_extraction/pp_3_100_BDTG/2gaus_1fit/pp_12_5_15_BDT4_100_MC_2gaus_fit_hits.root");
...
double accp_PbPb = hrecoeff_combine->GetBinContent(hrecoeff_combine->FindBin(14));
double promptratio_PbPb = 0.9;
double accp_pp = hrecoeffi_weighted_pp->GetBinContent(hrecoeffi_weighted_pp->FindBin(14));
double prompratio_pp = h_ratio_pp->GetBinContent(h_ratio_pp->FindBin(14));
TNtuple *nt_PbPb = (TNtuple*)f->Get("nt_2");
TNtuple *nt_pp = (TNtuple*)f_pp->Get("BDTG_125_15_value_0_77");
...
RooRealVar mean_pp("mean_pp","mean_pp",mean_value_pp,2.27,2.3);
...
RooRealVar p1_pp("p1_pp","p1_pp",-1.50487e-01,-1,1);
RooRealVar p2_pp("p2_pp","p2_pp",-6.10157e-02,-1,1);
...
RooRealVar p1_PbPb("p1_PbPb","p1_PbPb",-1.13425e-01,-1,1);
RooRealVar p2_PbPb("p2_PbPb","p2_PbPb",-3.98696e-02,-1,1);
...
massframe1->SetAxisRange(1800,3000,"Y");///separate pt train
massframe1->Draw();
TLatex* tex_pp;
tex_pp = new TLatex(0.16,0.85,"12.5 < p_{T} < 15 GeV/c");
tex_pp->SetNDC();
...
massframe2->SetAxisRange(68000,97000,"Y");
massframe2->Draw();

TLatex* tex;
tex = new TLatex(0.2,0.84,"12.5 < p_{T} < 15 GeV/c");
tex->SetNDC();
tex->SetTextFont(42);
...
c1->SaveAs("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/Raa_ratio_fit/full_statistics_pp_BDTG_3_100_workingscan_077/PbPb_125_15_rec_unbinned_3gaus_Raa.pdf");
c1->SaveAs("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/Raa_ratio_fit/full_statistics_pp_BDTG_3_100_workingscan_077/PbPb_125_15_rec_unbinned_3gaus_Raa.C");

TFile *result = new TFile("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/Raa_ratio_fit/full_statistics_pp_BDTG_3_100_workingscan_077/PbPb_125_15_2gaus_pol3_unbinned_rec_3gaus_Raa.root","RECREATE");
