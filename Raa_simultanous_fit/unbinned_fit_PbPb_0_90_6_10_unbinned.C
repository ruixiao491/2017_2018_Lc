...
void unbinned_fit_PbPb_0_90_6_10_unbinned(){
/////PbPb cen0_100%

//TFile *f =  new TFile("/scratch/brown/xiao147/2018PbPb_rereco_data_Dntuple_05052020_firstturn/masstuples_first_test_2servers_whole.root");
TFile *f = new TFile("/scratch/halstead/x/xiao147/2018_PbPb_transfer_from_brown_rice/final_PbPb_masstuples_copyfrombrown_forRaa_simultaneousfit/pt_6_8_cen0_90_total_2servers_whole.root");//total statistics
...
TFile *f_fun = new TFile("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/MC_fit/3gaus_fit/10_40_rec/10_30_uniform_rec/pp_6_8_MC_3gaus_fit_finbins.root");
...
TFile *f_fun_pp = new TFile("/scratch/halstead/x/xiao147/2017_pp_firstturn_dataproduction_0416_2019/signal_extraction/pp_3_100_BDTG/2gaus_1fit/pp_6_8_BDT4_100_MC_2gaus_fit_hits.root");
...
double accp_PbPb = hrecoeff_combine->GetBinContent(hrecoeff_combine->FindBin(7));
double promptratio_PbPb = 0.93;
double accp_pp = hrecoeffi_weighted_pp->GetBinContent(hrecoeffi_weighted_pp->FindBin(7));
double prompratio_pp = h_ratio_pp->GetBinContent(h_ratio_pp->FindBin(7));
TNtuple *nt_PbPb = (TNtuple*)f->Get("nt_mass");
TNtuple *nt_pp = (TNtuple*)f_pp->Get("BDTG_6_8_value_0_77");
...
RooRealVar NumBkg_PbPb("NumBkg_PbPb","Number of Background PbPb",numberb_PbPb,-numberb_PbPb*12,numberb_PbPb*12);
...
massframe1->SetAxisRange(29500,44000,"Y");///separate pt train
massframe1->Draw();
TLatex* tex_pp;
tex_pp = new TLatex(0.16,0.85,"6 < p_{T} < 8 GeV/c");
tex_pp->SetNDC();
...
massframe2->SetAxisRange(1000000,1165000,"Y");
massframe2->Draw();

TLatex* tex;
tex = new TLatex(0.2,0.84,"6 < p_{T} < 8 GeV/c");
tex->SetNDC();
tex->SetTextFont(42);
...
c1->SaveAs("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/Raa_ratio_fit/full_statistics_pp_BDTG_3_100_workingscan_077/PbPb_6_8_3gaus_sys_Raa.pdf");
c1->SaveAs("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/Raa_ratio_fit/full_statistics_pp_BDTG_3_100_workingscan_077/PbPb_6_8_3gaus_sys_Raa.C");

TFile *result = new TFile("/home/xiao147/private/2018_PbPb_Lc_rereco_Dntuple/CMSSW_10_3_3_patch1/src/Bfinder/Bfinder/Dntuple/analysis_steps/signal_fit_firstturn/ROOT_files/Raa_ratio_fit/full_statistics_pp_BDTG_3_100_workingscan_077/PbPb_6_8_2gaus_pol3_3gaus_sys_Raa.root","RECREATE");
