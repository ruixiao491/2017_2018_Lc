...
void TMVAClassification_trigger_BS_pp_combine6_20_depth_test_delet(TString collisionsyst, float ptMin, float ptMax, TString myMethodList, int cut_number, std::string cut_list_number, TString name_variable)
{
  Bool_t isPbPb;
