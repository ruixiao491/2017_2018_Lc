...
void TMVAClassification_trigger_BS_pp_combine6_20(TString collisionsyst="pp", float ptMin=10.0, float ptMax=20.0, TString myMethodList = "BDT" )
{
  Bool_t isPbPb;
  ...
  TString outfileName(Form("ROOT/TMVA_%s_%.0f_%.0f_%s.root",colsyst.Data(),ptmin,ptmax,myMethodList.Data()));
  TString outputstr(Form("TMVAClassification_%s_%.0f_%.0f_%s_weights",colsyst.Data(),ptmin,ptmax,myMethodList.Data()));
