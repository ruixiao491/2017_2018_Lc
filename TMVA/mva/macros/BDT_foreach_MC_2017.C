...
int BDT_foreach_MC_2017(TString inputfile="", TString outfile1="", int pbpb=0, int ptMin=4, int ptMax=100, string mvatype="BDT",int cut_number=5,TString name_variable="0_1_2_3_5")
{
...
*/
		inputfile = "/scratch/halstead/x/xiao147/official_2017_18_MC/pp_Dntuple/pp_pt4_MC_Dntuple/with_geninfo_nonprompt_info/MC_pkpi_pt4_whole.root";
		outfile1 = Form("/scratch/halstead/x/xiao147/official_2017_18_MC/pp_Dntuple/pp_pt4_MC_Dntuple/with_geninfo_nonprompt_info/Fill_BDT_4_100_withgeninfo/pkpi_pt4_MC_%s_pT%i_%i_%i_cutvariable_%s_DATA.root",MVAtype.Data(),ptMin,ptMax,cut_number,name_variable.Data());
...
int main(int argc, char *argv[])
{
	if(argc==3)
	{
		BDT_foreach_MC_2017(argv[1], argv[2]);
	}
	else
	{
