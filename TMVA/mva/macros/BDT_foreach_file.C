...
int BDT_foreach_file(TString inputfile="", TString outfile1="", int pbpb=0, int ptMin=3, int ptMax=100, string mvatype="BDT",int cut_number=5,TString name_variable="0_1_2_3_5")
{
	...
	if(istest)
	{
		...
		inputfile = "/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/skim_forBDT/pp2017data_forlambdapkpi/skim_without_HIZero7/HIZero1/HIZero1_0000/Dntuple_Dntuple_HiForestAOD_100.root_0.root_2.root";
...
int main(int argc, char *argv[])
{
	if(argc==3)
	{
		BDT_foreach_file(argv[1], argv[2]);
	}
	else
	{
