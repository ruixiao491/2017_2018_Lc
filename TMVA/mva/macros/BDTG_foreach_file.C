...
int BDTG_foreach_file(TString inputfile="", TString outfile1="", int pbpb=0, int ptMin=3, int ptMax=100, string mvatype="BDTG",int cut_number=5,TString name_variable="0_1_2_3_5")
{
	...
	if(istest)
	{
		...
		//inputfile = "/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/skim_forBDT/pp2017data_forlambdapkpi/skim_without_HIZero7/HIZero1/HIZero1_0000/Dntuple_Dntuple_HiForestAOD_1.root_110.root_0.root";
		inputfile = "/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/Dntuple_skim_witheventinfo/pp2017data_forlambdapkpi/HIZeroBias1/HIZeroBias1_0000/Dntuple_Dntuple_HiForestAOD_999.root_990.root_992.root";
		...
		outfile1 =Form("MB_%s_pT%i_%i_%i_cutvariable_%s_DATA.root",MVAtype.Data(),ptMin,ptMax,cut_number,name_variable.Data());
	...
	t->SetBranchAddress("pass12trigger",&pass12trigger);
...
int main(int argc, char *argv[])
{
	if(argc==3)
	{
		BDTG_foreach_file(argv[1], argv[2]);
	}
	else
	{
