...
cd /home/xiao147/private/TMVA_lambdaC/CMSSW_7_5_8_patch3/src
...
do
	...
	echo "Outputfile: $Outputfile"
        ./BDTG_foreach_file.exe $Inputfile $Outputfile
        #./BDT_foreach_file.exe $Inputfile $Outputfile
        #./BDT_foreach_file_PbPb.exe $Inputfile $Outputfile
		#./../../masstuples/make_tuple_for_Roofit_alldata_pp_agreedMC_noalpha_uniform_cutsgetfromKevin_allpTranges.exe $Inputfile $Outputfile
		#./../../masstuples/make_tuple_for_Roofit_alldata_pp_agreedMC_noalpha_uniform_cutsgetfromKevin_allpTranges_3_100_BDTG_workingpoint_scan.exe $Inputfile $Outputfile
		#./../../masstuples/make_tuple_for_Roofit_alldata_pp_agreedMC_noalpha_uniform_cutsgetfromKevin_3_4.exe $Inputfile $Outputfile
		#./../../masstuples/make_tuple_for_Roofit_alldata_pp_agreedMC_noalpha_uniform_cutsgetfromKevin_3_5.exe $Inputfile $Outputfile
