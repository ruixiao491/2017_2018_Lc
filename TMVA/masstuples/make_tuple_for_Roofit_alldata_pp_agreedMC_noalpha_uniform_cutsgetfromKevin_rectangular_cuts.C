...
//int make_tuple_for_Roofit_alldata_pp_agreedMC_noalpha_uniform_cutsgetfromKevin_rectangular_cuts(TString infile="/scratch/halstead/x/xiao147/2017_pp_firstturn_dataproduction_0416_2019/fill_BDT/HIZero1/Dntuple_Dntuple_Dntuple_HiForestAOD_1.root_110.root_0.root_1109.root", TString outfile="test.root",  Bool_t iseos=false)
{
	...
	TNtuple *nt1 = new TNtuple("nt1", "pp_Kevin_20_30_nopion_withdls2","mass");
	TNtuple *nt2 = new TNtuple("nt2", "pp_Kevin_30_40_nopion_withdls2","mass");
	TNtuple *nt3 = new TNtuple("nt3", "pp_Kevin_40_60_nopion_withdls2","mass");
	TNtuple *nt4 = new TNtuple("nt4", "pp_Kevin_60_100_nopion_withdls2","mass");
	TNtuple *nt5 = new TNtuple("nt5", "pp_Kevin_20_40_nopion_withdls2","mass");
