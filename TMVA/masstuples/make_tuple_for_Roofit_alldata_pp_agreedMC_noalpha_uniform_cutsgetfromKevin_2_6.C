...
int make_tuple_for_Roofit_alldata_pp_agreedMC_noalpha_uniform_cutsgetfromKevin_2_6(TString infile, TString outfile,  Bool_t iseos=false)
//int make_tuple_for_Roofit_alldata_pp_agreedMC_noalpha_uniform_cutsgetfromKevin_2_6(TString infile="/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/fill_BDT_3_6/pp2017data_forlambdapkpi/HIZero1/HIZero1_0000/Dntuple_Dntuple_Dntuple_HiForestAOD_993.root_984.root_986.root_984.root", TString outfile="test.root",  Bool_t iseos=false)
{
	...
	TNtuple *nt1 = new TNtuple("nt1", "pp_Kevin_3_4_BDT_3_6","mass");
	TNtuple *nt2 = new TNtuple("nt2", "pp_Kevin_4_5_BDT_3_6","mass");
	TNtuple *nt3 = new TNtuple("nt3", "pp_Kevin_5_6_BDT_3_6","mass");
	TNtuple *nt4 = new TNtuple("nt4", "pp_Kevin_3_6_BDT_3_6","mass");
	...
	double BDT_pt_3_6_5_cutvar_0_1_2_3_5_weight[MAX_XB];
	float DlxyBS[MAX_XB];
	...
	mvaTree->SetBranchAddress("BDT_pt_3_6_5_cutvar_0_1_2_3_5_weight",BDT_pt_3_6_5_cutvar_0_1_2_3_5_weight);
...
/////hits cuts
				...
				if(Dpt[i]>3&&Dpt[i]<6&&Dtrk1PtErr[i]/Dtrk1Pt[i]<0.3&&Dtrk2PtErr[i]/Dtrk2Pt[i]<0.3&&Dtrk3PtErr[i]/Dtrk3Pt[i]<0.3&&abs(Dtrk1Eta[i])<1.5&&abs(Dtrk2Eta[i])<1.5&&abs(Dtrk3Eta[i])<1.5&&abs(Dy[i])<1&&Dtrk1highPurity[i]==1&&Dtrk2highPurity[i]==1&&Dtrk3highPurity[i]==1&&DlxyBS[i]/sqrt(DlxyBSErr[i])>2&&BDT_pt_3_6_5_cutvar_0_1_2_3_5_weight[i]>0.0953&&(Dtrk1PixelHit[i]+Dtrk1StripHit[i])>=11&&(Dtrk2PixelHit[i]+Dtrk2StripHit[i])>=11&&(Dtrk3PixelHit[i]+Dtrk3StripHit[i])>=11)
				{
					nt4->Fill(Dmass[i]);
				}
...
int main(int argc, char *argv[])
{
	if(argc==3)
	{
		make_tuple_for_Roofit_alldata_pp_agreedMC_noalpha_uniform_cutsgetfromKevin_2_6(argv[1], argv[2]);
	}
	else
	{
