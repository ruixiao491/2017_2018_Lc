...
int make_tuple_for_Roofit_alldata_pp_agreedMC_noalpha_uniform_cutsgetfromKevin_2_3(TString infile, TString outfile,  Bool_t iseos=false)
//int make_tuple_for_Roofit_alldata_pp_agreedMC_noalpha_uniform_cutsgetfromKevin_2_3(TString infile="/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/fill_BDT_3_4/pp2017data_forlambdapkpi/HIZero1/HIZero1_0000/Dntuple_Dntuple_Dntuple_HiForestAOD_997.root_988.root_990.root_988.root", TString outfile="test.root",  Bool_t iseos=false)
{
	...
	TNtuple *nt1 = new TNtuple("nt1", "pp_Kevin_2_3_BDT_2_3","mass");
	...
	double BDT_pt_3_4_5_cutvar_0_1_2_3_5_weight[MAX_XB];
	float DlxyBS[MAX_XB];
	...
	mvaTree->SetBranchAddress("BDT_pt_3_4_5_cutvar_0_1_2_3_5_weight",BDT_pt_3_4_5_cutvar_0_1_2_3_5_weight);
...
int main(int argc, char *argv[])
{
	if(argc==3)
	{
		make_tuple_for_Roofit_alldata_pp_agreedMC_noalpha_uniform_cutsgetfromKevin_2_3(argv[1], argv[2]);
	}
	else
	{
