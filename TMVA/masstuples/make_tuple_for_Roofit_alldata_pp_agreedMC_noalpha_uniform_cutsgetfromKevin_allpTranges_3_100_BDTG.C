...
//int make_tuple_for_Roofit_alldata_pp_agreedMC_noalpha_uniform_cutsgetfromKevin_allpTranges_3_100_BDTG(TString infile, TString outfile,  Bool_t iseos=false)
int make_tuple_for_Roofit_alldata_pp_agreedMC_noalpha_uniform_cutsgetfromKevin_allpTranges_3_100_BDTG(TString infile="/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/fill_3_100_BDTG/pp2017data_forlambdapkpi/HIZero1/HIZero1_0000/Dntuple_Dntuple_Dntuple_HiForestAOD_1.root_110.root_0.root_110.root", TString outfile="test_1.root",  Bool_t iseos=false)
{
	...
	TNtuple *nt0 = new TNtuple("nt0", "pp_Kevin_3_4_nopion_BDT_withhitscut","mass");
...
int main(int argc, char *argv[])
{
	if(argc==3)
	{
		make_tuple_for_Roofit_alldata_pp_agreedMC_noalpha_uniform_cutsgetfromKevin_allpTranges_3_100_BDTG(argv[1], argv[2]);
	}
	else
	{
