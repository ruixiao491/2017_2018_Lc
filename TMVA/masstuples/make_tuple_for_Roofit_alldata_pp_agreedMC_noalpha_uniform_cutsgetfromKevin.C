...
int make_tuple_for_Roofit_alldata_pp_agreedMC_noalpha_uniform_cutsgetfromKevin(TString infile, TString outfile,  Bool_t iseos=false)
{
	...
	TNtuple *nt1 = new TNtuple("nt1", "pp_Kevin_10_20_nopion_noprecuts_BDT","mass");
	TNtuple *nt2 = new TNtuple("nt2", "pp_Kevin_8_10_nopion_noprecuts_BDT","mass");
	TNtuple *nt3 = new TNtuple("nt3", "pp_Kevin_6_8_nopion_noprecuts_BDT","mass");
	TNtuple *nt4 = new TNtuple("nt4", "pp_Kevin_5_6_nopion_noprecuts_BDT","mass");
	TNtuple *nt5 = new TNtuple("nt5", "pp_Kevin_5_20_nopion_noprecuts_BDT","mass");
	TNtuple *nt6 = new TNtuple("nt6", "pp_Kevin_10_20_nopion_nodls_rectan","mass");
	TNtuple *nt7 = new TNtuple("nt7", "pp_Kevin_8_10_nopion_nodls_rectan","mass");
	TNtuple *nt8 = new TNtuple("nt8", "pp_Kevin_6_8_nopion_nodls_rectan","mass");
	TNtuple *nt9 = new TNtuple("nt9", "pp_Kevin_5_6_nopion_nodls_rectan","mass");
	TNtuple *nt10 = new TNtuple("nt10", "pp_Kevin_5_20_nopion_nodls_rectan","mass");
	...
	for (int entry = 0; entry < t2->GetEntries(); entry++)
	{
		...
		if (abs(PVz)<15&&pBeamScrapingFilter&&pPAprimaryVertexFilter&&pass12trigger)
		{
			for (int i = 0; i < Dsize; i++ )
			{
				...
				if(BDT_pt_5_20_5_cutvar_0_1_2_3_5_weight[i]>0.07&&Dpt[i]>10&&Dpt[i]<20&&Dtrk1PtErr[i]/Dtrk1Pt[i]<0.3&&Dtrk2PtErr[i]/Dtrk2Pt[i]<0.3&&Dtrk3PtErr[i]/Dtrk3Pt[i]<0.3&&abs(Dtrk1Eta[i])<1.5&&abs(Dtrk2Eta[i])<1.5&&abs(Dtrk3Eta[i])<1.5&&abs(Dy[i])<1&&Dtrk1highPurity[i]==1&&Dtrk2highPurity[i]==1&&Dtrk3highPurity[i]==1)
				{
					nt1->Fill(Dmass[i]);
				}
				if(BDT_pt_5_20_5_cutvar_0_1_2_3_5_weight[i]>0.07&&Dpt[i]>8&&Dpt[i]<10&&Dtrk1PtErr[i]/Dtrk1Pt[i]<0.3&&Dtrk2PtErr[i]/Dtrk2Pt[i]<0.3&&Dtrk3PtErr[i]/Dtrk3Pt[i]<0.3&&abs(Dtrk1Eta[i])<1.5&&abs(Dtrk2Eta[i])<1.5&&abs(Dtrk3Eta[i])<1.5&&abs(Dy[i])<1&&Dtrk1highPurity[i]==1&&Dtrk2highPurity[i]==1&&Dtrk3highPurity[i]==1)
				{
					nt2->Fill(Dmass[i]);
				}
				if(BDT_pt_5_20_5_cutvar_0_1_2_3_5_weight[i]>0.07&&Dpt[i]>6&&Dpt[i]<8&&Dtrk1PtErr[i]/Dtrk1Pt[i]<0.3&&Dtrk2PtErr[i]/Dtrk2Pt[i]<0.3&&Dtrk3PtErr[i]/Dtrk3Pt[i]<0.3&&abs(Dtrk1Eta[i])<1.5&&abs(Dtrk2Eta[i])<1.5&&abs(Dtrk3Eta[i])<1.5&&abs(Dy[i])<1&&Dtrk1highPurity[i]==1&&Dtrk2highPurity[i]==1&&Dtrk3highPurity[i]==1)
				{
					nt3->Fill(Dmass[i]);
				}
				if(BDT_pt_5_20_5_cutvar_0_1_2_3_5_weight[i]>0.07&&Dpt[i]>5&&Dpt[i]<6&&Dtrk1PtErr[i]/Dtrk1Pt[i]<0.3&&Dtrk2PtErr[i]/Dtrk2Pt[i]<0.3&&Dtrk3PtErr[i]/Dtrk3Pt[i]<0.3&&abs(Dtrk1Eta[i])<1.5&&abs(Dtrk2Eta[i])<1.5&&abs(Dtrk3Eta[i])<1.5&&abs(Dy[i])<1&&Dtrk1highPurity[i]==1&&Dtrk2highPurity[i]==1&&Dtrk3highPurity[i]==1)
				{
					nt4->Fill(Dmass[i]);
				}
				if(BDT_pt_5_20_5_cutvar_0_1_2_3_5_weight[i]>0.07&&Dpt[i]>5&&Dpt[i]<20&&Dtrk1PtErr[i]/Dtrk1Pt[i]<0.1&&Dtrk2PtErr[i]/Dtrk2Pt[i]<0.1&&Dtrk3PtErr[i]/Dtrk3Pt[i]<0.1&&abs(Dtrk1Eta[i])<1.5&&abs(Dtrk2Eta[i])<1.5&&abs(Dtrk3Eta[i])<1.5&&abs(Dy[i])<1&&Dtrk1highPurity[i]==1&&Dtrk2highPurity[i]==1&&Dtrk3highPurity[i]==1)
				{
					nt5->Fill(Dmass[i]);
				}
				if(Dpt[i]>10&&Dpt[i]<20&&Dtrk1PtErr[i]/Dtrk1Pt[i]<0.3&&Dtrk2PtErr[i]/Dtrk2Pt[i]<0.3&&Dtrk3PtErr[i]/Dtrk3Pt[i]<0.3&&abs(Dtrk1Eta[i])<1.5&&abs(Dtrk2Eta[i])<1.5&&abs(Dtrk3Eta[i])<1.5&&abs(Dy[i])<1&&Dtrk1highPurity[i]==1&&Dtrk2highPurity[i]==1&&Dtrk3highPurity[i]==1&&DlxyBS[i]/sqrt(DlxyBSErr[i])>3.087&&Dchi2cl[i]>0.264&&alpha_BS_2D_correction[i]<0.251&&kaon_pt[i]/Dpt[i]>0.126&&proton_pt[i]/Dpt[i]>0.216)
				{   
					nt6->Fill(Dmass[i]);
				}
...
int main(int argc, char *argv[])
{
	if(argc==3)
	{
		make_tuple_for_Roofit_alldata_pp_agreedMC_noalpha_uniform_cutsgetfromKevin(argv[1], argv[2]);
	}
	else
	{
