...
RooRealVar NumBkg("NumBkg","Number of Background",numberb,-numberb*8,numberb*8);
...
model.plotOn(massframe,Name("back"),Components(back),LineColor(9),Range("cut_region"),NormRange("cut_region"));
...
massframe->SetAxisRange(100000,130000,"Y");
massframe->Draw();
...
*/
c1->SaveAs("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/pol3_2gaus/working_scan_BDTG077_changemassrange/pp_4_5_whole_DCA_range_withhits_pol1_default_float.pdf");
c1->SaveAs("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/pol3_2gaus/working_scan_BDTG077_changemassrange/pp_4_5_whole_DCA_range_withhits_pol1_default_float.C");

TFile *result = new TFile("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/pol3_2gaus/working_scan_BDTG077_changemassrange/pp_4_5_whole_DCA_range_withhits_pol1_default_float.root","RECREATE");
h_output->Write();
result->Close();
