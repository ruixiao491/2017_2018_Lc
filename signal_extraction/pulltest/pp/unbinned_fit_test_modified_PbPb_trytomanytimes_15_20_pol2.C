...
massframe->SetAxisRange(1200,1950,"Y");///separate pt train
massframe->Draw();
...
l1->SetLineWidth(3);
l1->Draw("same");
tex = new TLatex(0.17,0.85,"15 < p_{T} < 20 GeV/c");
tex->SetNDC();
tex->SetTextFont(42);
tex->SetTextSize(0.04);
tex->SetLineWidth(2);
...
Tl.SetTextFont(42);
Tl.DrawLatex(0.23,0.93, "#font[52]{Preliminary}");
c1->SaveAs("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/pulltest/BDTG_workingscan_077_3_100/default/pp_15_20_whole_DCA_range_withhits_cut.pdf");
c1->SaveAs("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/pulltest/BDTG_workingscan_077_3_100/default/pp_15_20_whole_DCA_range_withhits_cut.C");
/*
TFile *result = new TFile("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/pol3_2gaus/working_scan_BDTG077/pp_15_20_whole_DCA_withhitscut.root","RECREATE");
h_output->Write();
massframe->Write();
result->Close();
*/
