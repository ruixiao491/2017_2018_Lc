...
l1->SetLineWidth(3);
l1->Draw("same");
tex = new TLatex(0.17,0.85,"8 < p_{T} < 10 GeV/c");
tex->SetNDC();
tex->SetTextFont(42);
tex->SetTextSize(0.04);
tex->SetLineWidth(2);
...
c1->SaveAs("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/pulltest/BDTG_workingscan_077_3_100/default/pp_8_10_whole_DCA_range_withits_pulltest.pdf");
c1->SaveAs("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/pulltest/BDTG_workingscan_077_3_100/default/pp_8_10_whole_DCA_range_withhits_pullltest.C");
/*
TFile *result = new TFile("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/pol3_2gaus/working_scan_BDTG077/pp_8_10_whole_DCA_range_withhits.root","RECREATE");
h_output->Write();
massframe->Write();
result->Close();
*/
