...
l1->SetLineWidth(3);
l1->Draw("same");
tex = new TLatex(0.17,0.85,"10 < p_{T} < 12.5 GeV/c");
tex->SetNDC();
tex->SetTextFont(42);
tex->SetTextSize(0.04);
tex->SetLineWidth(2);
...
c1->SaveAs("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/pulltest/default/2gaus_pol3/pp_10_12_5_whole_DCA_range_withhits_cut_pulltest.pdf");
c1->SaveAs("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/pulltest/default/2gaus_pol3/pp_10_12_5_whole_DCA_range_withhits_cut_pulltest.C");

TFile *result = new TFile("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/pulltest/default/2gaus_pol3/pp_10_12_5_whole_DCA_withhitscut_pulltest.root","RECREATE");
h_output->Write();
massframe->Write();
result->Close();
