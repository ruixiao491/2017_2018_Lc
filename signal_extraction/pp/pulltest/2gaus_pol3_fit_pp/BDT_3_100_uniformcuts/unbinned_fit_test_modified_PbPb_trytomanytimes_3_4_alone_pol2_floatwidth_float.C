...
TFile *f_fun =  new TFile("/scratch/halstead/x/xiao147/2017_pp_firstturn_dataproduction_0416_2019/signal_extraction/pp_3_100_first_sight_fit/2gaus_1fit/pp_3_4_MC_2gaus_fit.root");
...
TNtuple *nt5 = (TNtuple*)f->Get("nt17");
...
RooRealVar p1("p1","p1",4.58489e-03,-1,1);
RooRealVar p2("p2","p2",-1.44907e-03,-1,1);
RooRealVar p3("p3","p3",-2.72944e-03,-1,1);
...
massframe->SetAxisRange(150000,170000,"Y");
massframe->Draw();
...
c1->SaveAs("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/signal_extraction/pp_nopartMB3_noMB7/2gaus_pol3/pp_3_4_whole_DCA_range_withhits.pdf");
c1->SaveAs("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/signal_extraction/pp_nopartMB3_noMB7/2gaus_pol3/pp_3_4_whole_DCA_range_withhits.C");
TFile *result = new TFile("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/signal_extraction/pp_nopartMB3_noMB7/2gaus_pol3/pp_3_4_whole_DCA_range_withhits.root","RECREATE");
h_output->Write();
result->Close();
