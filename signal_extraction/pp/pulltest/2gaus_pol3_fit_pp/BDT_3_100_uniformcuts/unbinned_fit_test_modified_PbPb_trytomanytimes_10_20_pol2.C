...
l1->SetLineWidth(3);
l1->Draw("same");
tex = new TLatex(0.17,0.85,"10 < p_{T} < 20 GeV/c");
tex->SetNDC();
tex->SetTextFont(42);
tex->SetTextSize(0.04);
tex->SetLineWidth(2);
...
c1->SaveAs("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/signal_extraction/pp_nopartMB3_noMB7_pulltest/2gaus_pol3/pp_10_20_whole_DCA_range_withhits_cut_pulltest.pdf");
c1->SaveAs("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/signal_extraction/pp_nopartMB3_noMB7_pulltest/2gaus_pol3/pp_10_20_whole_DCA_range_withhits_cut_pulltest.C");
