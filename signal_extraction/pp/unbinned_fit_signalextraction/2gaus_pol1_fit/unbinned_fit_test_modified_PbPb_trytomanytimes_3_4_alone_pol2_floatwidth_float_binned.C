...
void unbinned_fit_test_modified_PbPb_trytomanytimes_3_4_alone_pol2_floatwidth_float_binned(double float_values,TString outfile, TString outfigure,double numbers_val){
//pp 10-20
...
h_output->SetBinContent(3,r->minNll());
/*
RooDataSet* dsmall = (RooDataSet*) ds_1.reduce(EventRange(1,200)) ;
RooDataHist* dhsmall = dsmall->binnedClone() ;
RooChi2Var chi2_lowstat("chi2_lowstat","chi2",model,*dhsmall,4) ;
cout<<"chi2:  " << chi2_lowstat.getVal() << endl ;
*/
//cout<<massframe->chiSquare("model","ds",4);
