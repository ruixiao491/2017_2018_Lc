...
void unbinned_fit_test_modified_PbPb_trytomanytimes_10_20_pol2(){
//pp 10-20
TFile * f = new TFile("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/fill_3_100_BDTG/masstuples_whole.root");
//pp 10-20 pol2
TFile *f_fun = new TFile("/scratch/halstead/x/xiao147/2017_pp_firstturn_dataproduction_0416_2019/signal_extraction/pp_3_100_BDTG/2gaus_1fit/pp_10_20_BDT4_100_MC_2gaus_fit_hits.root");
...
TNtuple *nt1 = (TNtuple*)f->Get("nt5");
TH1F *hb = new TH1F("hb","hb",43,2.1,2.444);
nt1->Draw("mass>>hb");
double numbers = 3.43613e+03;
...
massframe->SetAxisRange(6000,10000,"Y");//without hits
massframe->Draw();
...
massframe->SetAxisRange(6000,10000,"Y");///separate pt train
massframe->Draw();
...
c1->SaveAs("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/signal_extraction/06052020_3_100_BDTG/pp_nopartMB3_noMB7/2gaus_pol3/pp_10_20_whole_DCA_range_withhits_cut.pdf");
c1->SaveAs("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/signal_extraction/06052020_3_100_BDTG/pp_nopartMB3_noMB7/2gaus_pol3/pp_10_20_whole_DCA_range_withhits_cut.C");

TFile *result = new TFile("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/signal_extraction/06052020_3_100_BDTG/pp_nopartMB3_noMB7/2gaus_pol3/pp_10_20_whole_DCA_withhitscut.root","RECREATE");
h_output->Write();
massframe->Write();
result->Close();
