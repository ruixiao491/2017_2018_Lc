...
void unbinned_fit_test_modified_PbPb_trytomanytimes_3_30_pol2(){
//pp 10-20
TFile * f = new TFile("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/fill_3_100_BDTG/cut_scan_whole.root");
//pp 10-20 pol2
...
massframe->SetAxisRange(425000,475000,"Y");///separate pt train
massframe->Draw();
...
c1->SaveAs("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/signal_extraction/06052020_3_100_BDTG/pp_nopartMB3_noMB7/2gaus_pol3/pp_3_30_whole_DCA_range_withhits.pdf");

TFile *result = new TFile("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/signal_extraction/06052020_3_100_BDTG/pp_nopartMB3_noMB7/2gaus_pol3/pp_3_30_whole_DCA_withhits.root","RECREATE");
h_output->Write();
massframe->Write();
result->Close();
