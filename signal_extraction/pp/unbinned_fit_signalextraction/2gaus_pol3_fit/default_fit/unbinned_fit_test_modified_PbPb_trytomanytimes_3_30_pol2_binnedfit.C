...
void unbinned_fit_test_modified_PbPb_trytomanytimes_3_30_pol2_binnedfit(){
//pp 10-20
TFile * f = new TFile("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/fill_3_100_BDTG/cut_scan_fullstatistics_0730_whole.root");
//pp 10-20 pol2
TFile *f_fun = new TFile("/scratch/halstead/x/xiao147/2017_pp_firstturn_dataproduction_0416_2019/signal_extraction/pp_3_100_BDTG/2gaus_1fit/pp_3_30_BDT4_100_MC_2gaus_fit_hits.root");
...
TNtuple *nt1 = (TNtuple*)f->Get("nt45");
TH1F *hb = new TH1F("hb","hb",42,2.108,2.444);
nt1->Draw("mass>>hb");
double numbers = 3.54487e+04;
...
massframe->SetAxisRange(490000,560000,"Y");///separate pt train
massframe->Draw();



TLatex* tex;
tex = new TLatex(0.16,0.85,"3 < p_{T} < 30 GeV/c");
tex->SetNDC();
tex->SetTextFont(42);
...
Tl.SetTextSize(0.05);
Tl.SetTextFont(42);
Tl.DrawLatex(0.18,0.93, "#font[61]{CMS }");
...
c1->SaveAs("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/signal_extraction/06052020_3_100_BDTG/pp_nopartMB3_noMB7/2gaus_pol3/pp_3_30_whole_DCA_range_withhits_binnedfit_fullstatistics.pdf");

TFile *result = new TFile("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/signal_extraction/06052020_3_100_BDTG/pp_nopartMB3_noMB7/2gaus_pol3/pp_3_30_whole_DCA_withhits_binnedfit_fullstatistics.root","RECREATE");
h_output->Write();
massframe->Write();
result->Close();
