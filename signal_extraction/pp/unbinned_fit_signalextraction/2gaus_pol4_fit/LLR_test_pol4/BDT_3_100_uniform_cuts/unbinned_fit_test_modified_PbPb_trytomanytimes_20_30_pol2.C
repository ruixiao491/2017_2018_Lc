...
//pp 10-20
TFile * f = new TFile("/scratch/halstead/x/xiao147/2017_pp_firstturn_dataproduction_0416_2019/fill_BDT/pp_3_100/masstupels_whole.root");
//pp 10-20 pol2
TFile *f_fun = new TFile("/scratch/halstead/x/xiao147/2017_pp_firstturn_dataproduction_0416_2019/signal_extraction/pp_3_100_first_sight_fit/2gaus_1fit/pp_20_30_MC_2gaus_fit.root");
...
massframe->SetAxisRange(250,550,"Y");
massframe->Draw();
...
//RooRealVar NumSig("NumSig","Number of Signal",numbers,-1e5,1e5);
...
massframe->SetAxisRange(250,550,"Y");///separate pt train
massframe->Draw();
...
leg = new TLegend(0.16,0.16,0.34,0.3);
...
c1->SaveAs("/scratch/halstead/x/xiao147/2017_pp_firstturn_dataproduction_0416_2019/signal_extraction/pp_3_100_first_sight_fit/data_unbinned_fit/pp_20_30_whole_DCA_range.pdf");

TFile *result = new TFile("/scratch/halstead/x/xiao147/2017_pp_firstturn_dataproduction_0416_2019/signal_extraction/pp_3_100_first_sight_fit/data_unbinned_fit/pp_20_30_whole_DCA.root","RECREATE");
h_output->Write();
massframe->Write();
result->Close();
