...
RooChebychev back("back","fourth polynomial",mass,RooArgList(p1,p2,p3,p4));
...
c1->SaveAs("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/signal_extraction/pp_nopartMB3_noMB7/2gaus_pol4/notfixshape_forLLR/pp_10_20_whole_DCA_range_withhits_cut.pdf");

TFile *result = new TFile("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/signal_extraction/pp_nopartMB3_noMB7/2gaus_pol4/notfixshape_forLLR/pp_10_20_whole_DCA_withhitscut.root","RECREATE");
h_output->Write();
massframe->Write();
result->Close();
