...
RooRealVar p3("p3","p3",-3.05098e-03,-1,1);
RooRealVar p4("p4","p4",-3.05098e-03,-1,1);
/*
RooRealVar p1("p1","p1",0,-1,1);
RooRealVar p2("p2","p2",0,-1,1);
*/
RooRealVar float_width("float_width","float_width",5.21060e-02,5.21060e-02,5.21060e-02);
...
c1->SaveAs("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/fill_3_100_BDTG/systematic_signal_extraction/pol4_fix_sig/pp_8_10_whole_DCA_range_withits_pol4.pdf");
c1->SaveAs("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/fill_3_100_BDTG/systematic_signal_extraction/pol4_fix_sig/pp_8_10_whole_DCA_range_withhits_pol4.C");

TFile *result = new TFile("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/fill_3_100_BDTG/systematic_signal_extraction/pol4_fix_sig/pp_8_10_whole_DCA_range_withhits_pol4.root","RECREATE");
h_output->Write();
massframe->Write();
result->Close();
