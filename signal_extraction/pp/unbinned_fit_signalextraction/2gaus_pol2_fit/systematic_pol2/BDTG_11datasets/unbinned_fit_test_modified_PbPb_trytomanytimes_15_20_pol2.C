...
c1->SaveAs("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/fill_3_100_BDTG/systematic_signal_extraction/pol2_fix_sig/pp_15_20_whole_DCA_range_withhits_cut.pdf");
c1->SaveAs("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/fill_3_100_BDTG/systematic_signal_extraction/pol2_fix_sig/pp_15_20_whole_DCA_range_withhits_cut.C");

TFile *result = new TFile("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/fill_3_100_BDTG/systematic_signal_extraction/pol2_fix_sig/pp_15_20_whole_DCA_withhitscut.root","RECREATE");
h_output->Write();
massframe->Write();
result->Close();
