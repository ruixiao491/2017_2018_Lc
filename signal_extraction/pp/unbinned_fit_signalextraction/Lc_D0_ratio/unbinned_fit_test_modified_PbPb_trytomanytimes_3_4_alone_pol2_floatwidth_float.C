...
double ND0 = hD0_crosssection->GetBinContent(hD0_crosssection->FindBin(3.5));
double ND0_err = hD0_crosssection->GetBinError(hD0_crosssection->FindBin(3.5));
double accp = hrecoeffi_weighted->GetBinContent(hrecoeffi_weighted->FindBin(3.5));
double prompratio = h_ratio->GetBinContent(h_ratio->FindBin(3.5));
double prompratio_err = h_ratio->GetBinError(h_ratio->FindBin(3.5));
...
RooRealVar ratio2("ratio2","ratio2",0.41149,-10,10);
...
c1->SaveAs("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/Lc_D0_fit/pp_3_4_fullstatistics_Lc_D0ratio_massplots.pdf");
c1->SaveAs("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/Lc_D0_fit/pp_3_4_fullstatistics_Lc_D0ratio_massplots.C");

TFile *result = new TFile("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/Lc_D0_fit/Lc_D0_ratio_3_4_pp_fullstatistics.root","RECREATE");
