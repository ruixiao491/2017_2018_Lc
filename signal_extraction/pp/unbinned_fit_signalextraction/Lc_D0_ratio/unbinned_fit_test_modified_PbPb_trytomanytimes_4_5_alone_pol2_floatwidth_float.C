...
TFile *f_accp = new TFile("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/accp/ROOT/BDTG/prompt_accp/fourth_turn/combine_pT_pp/prompt_pt2_pt4_pt10_combine_fourthturn.root");TFile *f_prompt_ratio = new TFile("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/accp/ROOT/BDTG/prompt_ratio_allpT_2017pp_BDTG.root");
...
double ND0 = hD0_crosssection->GetBinContent(hD0_crosssection->FindBin(4.5));
double ND0_err = hD0_crosssection->GetBinError(hD0_crosssection->FindBin(4.5));
double accp = hrecoeffi_weighted->GetBinContent(hrecoeffi_weighted->FindBin(4.5));
double prompratio = h_ratio->GetBinContent(h_ratio->FindBin(4.5));
double prompratio_err = h_ratio->GetBinError(h_ratio->FindBin(4.5));
...
RooRealVar ratio2("ratio2","ratio2",0.3359,-10,10);
...
RooChebychev back("back","third polynomial",mass,RooArgList(p1));
...
massframe->SetAxisRange(88000,122000,"Y");
massframe->Draw();
...
c1->SaveAs("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/Lc_D0_fit/Lc_D0_fit_345_float/pp_4_5_fullstatistics_Lc_D0ratio_massplots.pdf");
c1->SaveAs("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/Lc_D0_fit/Lc_D0_fit_345_float/pp_4_5_fullstatistics_Lc_D0ratio_massplots.C");

TFile *result = new TFile("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/Lc_D0_fit/Lc_D0_fit_345_float/Lc_D0_ratio_4_5_pp_fullstatistics.root","RECREATE");
h_output->Write();
result->Close();
