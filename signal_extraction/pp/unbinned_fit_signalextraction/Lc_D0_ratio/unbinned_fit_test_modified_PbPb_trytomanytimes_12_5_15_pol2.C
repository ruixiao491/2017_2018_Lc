...
double ND0 = hD0_crosssection->GetBinContent(hD0_crosssection->FindBin(13.75));
double ND0_err = hD0_crosssection->GetBinError(hD0_crosssection->FindBin(13.75));
double accp = hrecoeffi_weighted->GetBinContent(hrecoeffi_weighted->FindBin(13.75));
double prompratio = h_ratio->GetBinContent(h_ratio->FindBin(13.75));
...
RooRealVar ratio2("ratio2","ratio2",0.183995,-10,10);
...
c1->SaveAs("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/Lc_D0_fit/Lc_D0_fit_345_float/pp_125_15_fullstatistics_Lc_D0ratio_massplots.pdf");
c1->SaveAs("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/Lc_D0_fit/Lc_D0_fit_345_float/pp_125_15_fullstatistics_Lc_D0ratio_massplots.C");

TFile *result = new TFile("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/Lc_D0_fit/Lc_D0_fit_345_float/Lc_D0_ratio_125_15_pp_fullstatistics.root","RECREATE");
h_output->Write();
massframe->Write();
result->Close();
