...
void unbinned_fit_test_modified_PbPb_trytomanytimes_15_20_pol2(){
//pp 10-20
...
//pp 10-20 pol2
TFile *f_fun = new TFile("/scratch/halstead/x/xiao147/2017_pp_firstturn_dataproduction_0416_2019/signal_extraction/pp_3_100_BDTG/2gaus_1fit/pp_15_20_BDT4_100_MC_2gaus_fit_hits.root");
...
TFile *f_accp = new TFile("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/accp/ROOT/BDTG/prompt_accp_float345/third_turn/combine_pT_pp/prompt_pt2_pt4_pt10_combine_fourthturn.root");
TFile *f_prompt_ratio = new TFile("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/accp/ROOT/BDTG/prompt_ratio_allpT_2017pp_BDTG.root");
...
double mean_value = 2.28467e+00;
TH1F *h_output = new TH1F ("h_output","output",2,0,2);

//TNtuple *nt1 = (TNtuple*)f->Get("nt6");
TNtuple *nt1 = (TNtuple*)f->Get("nt18");
TH1F *hb = new TH1F("hb","hb",43,2.1,2.444);
nt1->Draw("mass>>hb");
double numbers = 638;
double numberb = hb->Integral();
double ND0 = hD0_crosssection->GetBinContent(hD0_crosssection->FindBin(17.5));
double ND0_err = hD0_crosssection->GetBinError(hD0_crosssection->FindBin(17.5));
double accp = hrecoeffi_weighted->GetBinContent(hrecoeffi_weighted->FindBin(17.5));
double prompratio = h_ratio->GetBinContent(h_ratio->FindBin(17.5));
double prompratio_err = h_ratio->GetBinError(h_ratio->FindBin(17.5));
...
massframe->SetAxisRange(1100,1850,"Y");//without hits
massframe->Draw();
...
RooRealVar ratio2("ratio2","ratio2",0.1596,-10,10);
RooRealVar ND0_var("ND0_var","ND0_var",ND0,ND0-10*ND0_err,ND0+10*ND0_err);
RooFormulaVar NumSig("NumSig","@0*@1*2*5*0.0635*0.252*1e6*@2/@3",RooArgSet(ratio2,ND0_var,Accp,P_ratio));
...
RooRealVar p1("p1","p1",-1.57964e-01,-1,1);
RooRealVar p2("p2","p2",-5.88992e-02,-1,1);
RooRealVar p3("p3","p3",1.93510e-02,-1,1);

//RooRealVar p1("p1","p1",0,-1,1);
//RooRealVar p2("p2","p2",0,-1,1);
RooRealVar float_width("float_width","float_width",2.40977e-01,-1,1);
...
massframe->SetAxisRange(1100,1850,"Y");///separate pt train
massframe->Draw();



TLatex* tex;
tex = new TLatex(0.16,0.85,"15 < p_{T} < 20 GeV/c");
tex->SetNDC();
tex->SetTextFont(42);
...
c1->SaveAs("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/Lc_D0_fit/Lc_D0_fit_345_float/pp_15_20_fullstatistics_Lc_D0_ratio_massplots.pdf");
c1->SaveAs("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/Lc_D0_fit/Lc_D0_fit_345_float/pp_15_20_fullstatistics_Lc_D0_ratio_massplots.C");

TFile *result = new TFile("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/Lc_D0_fit/Lc_D0_fit_345_float/Lc_D0_ratio_15_20_pp_fullstatistics.root","RECREATE");
h_output->Write();
massframe->Write();
result->Close();
