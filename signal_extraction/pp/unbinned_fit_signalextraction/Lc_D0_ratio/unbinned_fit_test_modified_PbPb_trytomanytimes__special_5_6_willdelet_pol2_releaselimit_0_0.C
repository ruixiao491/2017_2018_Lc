...
void unbinned_fit_test_modified_PbPb_trytomanytimes__special_5_6_willdelet_pol2_releaselimit_0_0(){
//pp 10-20
...
TFile *f_accp = new TFile("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/accp/ROOT/BDTG/prompt_accp_float345/fourth_turn/combine_pT_pp/prompt_pt2_pt4_pt10_combine_fourthturn.root");
...
double mean_value = 2.286;
TH1F *h_output = new TH1F ("h_output","output",2,0,2);



TNtuple *nt4 = (TNtuple*)f->Get("nt2");
TH1F *hb = new TH1F("hb","hb",43,2.1,2.444);
nt4->Draw("mass>>hb");
double numbers = 6200;
double numberb = hb->Integral();
double ND0 = hD0_crosssection->GetBinContent(hD0_crosssection->FindBin(5.5));
double ND0_err = hD0_crosssection->GetBinError(hD0_crosssection->FindBin(5.5));
double accp = hrecoeffi_weighted->GetBinContent(hrecoeffi_weighted->FindBin(5.5));
double prompratio = h_ratio->GetBinContent(h_ratio->FindBin(5.5));
double prompratio_err = h_ratio->GetBinError(h_ratio->FindBin(5.5));
...
RooRealVar ratio2("ratio2","ratio2",0.26,-10,10);
RooRealVar ND0_var("ND0_var","ND0_var",ND0,ND0-4*ND0_err,ND0+4*ND0_err);
RooFormulaVar NumSig("NumSig","@0*@1*2*1*0.0635*0.252*1e6*@2/@3",RooArgSet(ratio2,ND0_var,Accp,P_ratio));
...
RooRealVar p1("p1","p1",-8.35716e-02,-1,1);
RooRealVar p2("p2","p2",-2.66963e-03,-1,1);
/*
...
RooChebychev back("back","second polynomial",mass,RooArgList(p1,p2));
...
massframe->SetTitleOffset(1.82,"Y");
...
massframe->SetAxisRange(35500,53000,"Y");
massframe->Draw();

TLatex* tex;
tex = new TLatex(0.16,0.85,"5 < p_{T} < 6 GeV/c");
tex->SetNDC();
tex->SetTextFont(42);
...
c1->SaveAs("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/Lc_D0_fit/Lc_D0_fit_345_float/pp_5_6_fullstatistics_Lc_D0_masplots.pdf");
c1->SaveAs("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/Lc_D0_fit/Lc_D0_fit_345_float/pp_5_6_fullstatistics_Lc_D0_masplots.C");


TFile *result = new TFile("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/Lc_D0_fit/Lc_D0_fit_345_float/Lc_D0_ratio_5_6_pp_fullstatistics.root","RECREATE");
h_output->Write();
massframe->Write();
result->Close();
