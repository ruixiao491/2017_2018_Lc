...
void unbinned_fit_test_modified_PbPb_trytomanytimes_10_12_5_pol2(){
//pp 10-20
...
TNtuple *nt1 = (TNtuple*)f->Get("nt16");
TH1F *hb = new TH1F("hb","hb",43,2.1,2.444);
nt1->Draw("mass>>hb");
double numbers = 2451;
double numberb = hb->Integral();
double ND0 = hD0_crosssection->GetBinContent(hD0_crosssection->FindBin(11.25));
double ND0_err = hD0_crosssection->GetBinError(hD0_crosssection->FindBin(11.25));
double accp = hrecoeffi_weighted->GetBinContent(hrecoeffi_weighted->FindBin(11.25));
double prompratio = h_ratio->GetBinContent(h_ratio->FindBin(11.25));
double prompratio_err = h_ratio->GetBinError(h_ratio->FindBin(11.25));

cout<<"ND0_err:  "<<ND0_err<<"      "<<"prompt ratio:    "<<prompratio<<endl;
...
massframe->SetAxisRange(4000,7000,"Y");//without hits
massframe->Draw();
...
RooRealVar ratio2("ratio2","ratio2",0.246,-10,10);
RooRealVar ND0_var("ND0_var","ND0_var",ND0,ND0-10*ND0_err,ND0+10*ND0_err);
RooFormulaVar NumSig("NumSig","@0*@1*2*2.5*0.0635*0.252*1e6*@2/@3",RooArgSet(ratio2,ND0_var,Accp,P_ratio));
//RooFormulaVar NumSig("NumSig","@0*@1*2*2.5*0.0635*0.252*1e6*0.1587951218",RooArgSet(ratio2,ND0_var));
...
//RooRealVar p1("p1","p1",0,-1,1);
//RooRealVar p2("p2","p2",0,-1,1);
RooRealVar float_width("float_width","float_width",0,-1,1);
...
massframe->SetAxisRange(4000,7000,"Y");///separate pt train
massframe->Draw();
...
c1->SaveAs("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/Lc_D0_fit/Lc_D0_fit_345_float/pp_10_125_fullstatistics_Lc_D0_ratio_masplots.pdf");
c1->SaveAs("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/Lc_D0_fit/Lc_D0_fit_345_float/pp_10_125_fullstatistics_Lc_D0_ratio_masplots.C");

TFile *result = new TFile("/home/xiao147/private/2017_pp_Lc_speedup_version_2_toDtuple/CMSSW_9_4_10/src/Bfinder/Bfinder/Dntuple/analysis_firstturn_04072020/signal_fit_firstturn_02062020/ROOT/default_fit/Lc_D0_fit/Lc_D0_fit_345_float/Lc_D0_ratio_10_125_pp_fullstatistics.root","RECREATE");
h_output->Write();
massframe->Write();
result->Close();
