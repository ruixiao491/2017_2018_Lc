...
TFile *f_fun_MC = new TFile("/scratch/halstead/x/xiao147/2017_pp_firstturn_dataproduction_0416_2019/signal_extraction/pp_3_100_first_sight_fit/2gaus_1fit/pp_8_10_MC_2gaus_fit.root");
...
TNtuple *nt2 = (TNtuple*)f->Get("nt21");
...
massframe->SetAxisRange(6000,10500,"Y");//uniform train 
...
w->import(ds);
w->Print();
w->writeToFile("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/signal_extraction/pp_nopartMB3_noMB7_toyMC/2gaus_pol3_pp/pp_8_10_withits_whole_DCA_range_withhits_cut_toyMC.root");
...
c1->SaveAs("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/signal_extraction/pp_nopartMB3_noMB7_toyMC/2gaus_pol3_pp/pp_8_10_withhits_whole_DCA_range_withhits_cut_toyMC.pdf");
c1->SaveAs("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/signal_extraction/pp_nopartMB3_noMB7_toyMC/2gaus_pol3_pp/pp_8_10_withhits_whole_DCA_range_withhits_cut_toyMC.C");
