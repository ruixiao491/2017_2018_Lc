...
//pp 10-20 pol2
TFile *f_fun = new TFile("/scratch/halstead/x/xiao147/2017_pp_firstturn_dataproduction_0416_2019/signal_extraction/pp_3_100_first_sight_fit/2gaus_1fit/pp_10_20_MC_2gaus_fit.root");
...
TNtuple *nt1 = (TNtuple*)f->Get("nt22");
...
massframe->SetAxisRange(5000,9000,"Y");//without hits
massframe->Draw();
...
massframe->SetAxisRange(5000,9000,"Y");///separate pt train
massframe->Draw();
...
w->import(ds);
w->Print();
w->writeToFile("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/signal_extraction/pp_nopartMB3_noMB7_toyMC/2gaus_pol3_pp/pp_10_20_whole_DCA_range_withhits_cut_toyMC.root");
...
c1->SaveAs("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/signal_extraction/pp_nopartMB3_noMB7_toyMC/2gaus_pol3_pp/pp_10_20_whole_DCA_range_withhits_cut_toyMC.pdf");
c1->SaveAs("/scratch/halstead/x/xiao147/2017_pp_fullproduction_03112020_2/signal_extraction/pp_nopartMB3_noMB7_toyMC/2gaus_pol3_pp/pp_10_20_whole_DCA_range_withhits_cut_toyMC.C");
