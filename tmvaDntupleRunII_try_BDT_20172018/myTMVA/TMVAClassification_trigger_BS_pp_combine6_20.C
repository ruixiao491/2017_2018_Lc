...
void TMVAClassification_trigger_BS_pp_combine6_20(TString collisionsyst, float ptMin, float ptMax, TString myMethodList, int cut_number, std::string cut_list_number, TString name_variable)
{
  Bool_t isPbPb;
...
*/
	...
	cut_list.push_back("(log10(DlxyBS/sqrt(DlxyBSErr)))");//0
