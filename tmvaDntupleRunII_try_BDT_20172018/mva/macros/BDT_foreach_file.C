...
int BDT_foreach_file(TString inputfile="", TString outfile1="", int pbpb=0, int ptMin=3, int ptMax=4, string mvatype="BDT",int cut_number=5,TString name_variable="0_1_2_3_5")
{
