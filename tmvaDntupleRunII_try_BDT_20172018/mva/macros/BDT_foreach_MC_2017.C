...
int BDT_foreach_MC_2017(TString inputfile="", TString outfile1="", int pbpb=0, int ptMin=5, int ptMax=20, string mvatype="BDT",int cut_number=5,TString name_variable="0_1_2_3_5")
{
...
*/
		inputfile = "/scratch/halstead/x/xiao147/official_2017_18_MC/pp_Dntuple/pp_pt4_MC_Dntuple/delta_whole.root";
		outfile1 = Form("/scratch/halstead/x/xiao147/official_2017_18_MC/pp_Dntuple/pp_pt4_MC_Dntuple/fill_BDT/delta_%s_pT%i_%i_%i_cutvariable_%s_DATA.root",MVAtype.Data(),ptMin,ptMax,cut_number,name_variable.Data());
	...
	string a1="(DlxyBS/sqrt(DlxyBSErr))";//0
	string a2="Dchi2cl";//1
	...
	for(int i=0;i<t->GetEntries();i++)
	{
		...
		for(int j=0;j<Dsize;j++)
		{
			...
			{
				inputValues.clear();
				inputValues.push_back((DlxyBS[j]/sqrt(DlxyBSErr[j])));//0
